...
|---------------------------------------------|---------------------------------------------------|----------------------------------------------|-------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| Cancer Study                                | Required                                           | meta_study.txt                              | Text file                           | Overall information about the study                                  | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/01_cancer_study) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/01_cancer_study/meta_study.txt) |
| Clinical Sample Metadata                    | Required                                           | meta_clinical_sample.txt                    | Text File                           | A meta file with information about the clinical samples              | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/meta_clinical_sample.txt) |
| Clinical Sample Data                        | Required                                           | data_clinical_sample.txt                    | Tab Separated Value (TSV)          | File with the sample-level clinical covariates/metadata             | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/data_clinical_sample.txt) |
| Case Lists                                  | Required                                           | case_lists/cases_sequenced.txt             | Multi-line text file                | It helps cBioPortal identify which samples have data               | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/05_case_lists) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/05_case_lists/case_lists/cases_sequenced.txt) |
| Cancer Type Metadata                        | Optional                                           | meta_cancer_type.txt                        | Text File                           | A meta file with information about the file with new cancer type    | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type/meta_cancer_type.txt) |
| Cancer Type                                 | Optional                                           | cancer_type.txt                             | Tab Separated Value (TSV)          | Details about a new cancer type not found in the cBioPortal database | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type/cancer_type.txt) |
| Clinical Patient Metadata                   | Optional                                           | meta_clinical_patient.txt                   | Multi-line text file                | A meta file with information about the clinical patient             | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/meta_clinical_patient.txt) |
| Clinical Patient                            | Optional                                           | data_clinical_patient.txt                   | Tab Separated Value (TSV)          | File with the sample-level clinical covariates/metadata             | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/data_clinical_patient.txt) |
| Mutation Metadata                           | Optional                                           | meta_mutations.txt                          | Multi-line text file                | A meta file describing information about the mutation file          | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/meta_mutations.txt) |
| Mutation Data                               | Optional                                           | data_mutations.txt                          | Tab Separated Value (TSV)          | File with mutation data                                             | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/data_mutations.txt) |
| Panel Metadata                              | Optional                                           | meta_gene_panel_matrix.txt                  | Multi-line text file                | A meta file for describing the gene panel matrix file              | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/meta_gene_panel_matrix.txt) |
| Panel Data                                  | Optional                                           | data_gene_panel_matrix.txt                  | Tab Separated Value (TSV)          | Sample level details of the gene panel used for the different samples | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/data_gene_panel_matrix.txt) |
| Structural Variant Metadata                 | Optional                                           | meta_sv.txt                                 | Multi-line text file                | A meta file for describing the structural variant data file        | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants/meta_sv.txt) |
| Structural Variants                         | Optional                                           | data_sv.txt                                 | Tab Separated Value (TSV)          | File with structural variant data                                   | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants/data_sv.txt) |
| Generic Assays: Arm-level CNA Metadata      | Optional                                           | meta_armlevel_CNA.txt                       | Multi-line text file                | A meta file for arm-level copy number alteration data              | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna/meta_armlevel_CNA.txt) |
| Generic Assays: Arm-level CNA Data          | Optional                                           | data_armlevel_CNA.txt                       | Tab Separated Value (TSV)          | Arm-level copy number alteration data                               | [Readme](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna) | [Example](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna/data_armlevel_CNA.txt) |
