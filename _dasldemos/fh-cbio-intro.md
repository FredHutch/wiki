...
- Once your study files are close to complete, you can test out your file formatting using one of two validation methods:
    ...
    2. You could also validate your study folder by [launching a local instance](https://github.com/FredHutch/tg-cbioportal-data/tree/main/03_launch_local) of cBioPortal and troubleshooting the errors (if any) in your study data.
...
|---------------------------------------------|---------------------------------------------------|----------------------------------------------|-------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| Cancer Study                                | Required                                           | meta_study.txt                              | Text file                           | Overall information about the study                                  | [Readme for Cancer Study](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/01_cancer_study) | [Example of meta_study.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/01_cancer_study/meta_study.txt) |
| Clinical Sample Files                       | Required                                           | meta_clinical_sample.txt                    | Text File                           | A meta file with information about the clinical sample              | [Readme for Clinical Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example of meta_clinical_sample.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/meta_clinical_sample.txt) |
| Clinical Sample Files                       | Required                                           | data_clinical_sample.txt                    | Tab Separated Value (TSV)          | File with the sample-level clinical covariates/metadata             | [Readme for Clinical Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example of data_clinical_sample.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/data_clinical_sample.txt) |
| Case Lists                                  | Required                                           | case_lists/cases_sequenced.txt             | Multi-line text file                | It helps cBioPortal identify which samples have data               | [Readme for Case Lists](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/05_case_lists) | [Example of case_lists/cases_sequenced.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/05_case_lists/case_lists/cases_sequenced.txt) |
| Cancer Type Metadata                        | Optional                                           | meta_cancer_type.txt                        | Text File                           | A meta file with information about the file with new cancer type    | [Readme for Cancer Type](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type) | [Example of meta_cancer_type.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type/meta_cancer_type.txt) |
| Cancer Type                                 | Optional                                           | cancer_type.txt                             | Tab Separated Value (TSV)          | Details about a new cancer type not found in the cBioPortal database | [Readme for Cancer Type](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type) | [Example of cancer_type.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/02_cancer_type/cancer_type.txt) |
| Clinical Patient Metadata                   | Optional                                           | meta_clinical_patient.txt                   | Multi-line text file                | A meta file with information about the clinical patient             | [Readme for Clinical Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example of meta_clinical_patient.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/meta_clinical_patient.txt) |
| Clinical Patient                            | Optional                                           | data_clinical_patient.txt                   | Tab Separated Value (TSV)          | File with the sample-level clinical covariates/metadata             | [Readme for Clinical Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data) | [Example of data_clinical_patient.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/03_clinical_data/data_clinical_patient.txt) |
| Mutation Metadata                           | Optional                                           | meta_mutations.txt                          | Multi-line text file                | A meta file describing information about the mutation file          | [Readme for Mutation Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example of meta_mutations.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/meta_mutations.txt) |
| Mutation Data                               | Optional                                           | data_mutations.txt                          | Tab Separated Value (TSV)          | File with mutation data                                             | [Readme for Mutation Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example of data_mutations.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/data_mutations.txt) |
| Panel Metadata                              | Optional                                           | meta_gene_panel_matrix.txt                  | Multi-line text file                | A meta file for describing the gene panel matrix file              | [Readme for Mutation Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example of meta_gene_panel_matrix.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/meta_gene_panel_matrix.txt) |
| Panel Data                                  | Optional                                           | data_gene_panel_matrix.txt                  | Tab Separated Value (TSV)          | Sample level details of the gene panel used for the different samples | [Readme for Mutation Data](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data) | [Example of data_gene_panel_matrix.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/04_mutation_data/data_gene_panel_matrix.txt) |
| Structural Variant Metadata                 | Optional                                           | meta_sv.txt                                 | Multi-line text file                | A meta file for describing the structural variant data file        | [Readme for Structural Variants](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants) | [Example of meta_sv.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants/meta_sv.txt) |
| Structural Variants                         | Optional                                           | data_sv.txt                                 | Tab Separated Value (TSV)          | File with structural variant data                                   | [Readme for Structural Variants](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants) | [Example of data_sv.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/06_structural_variants/data_sv.txt) |
| Generic Assays: Arm-level CNA Metadata      | Optional                                           | meta_armlevel_CNA.txt                       | Multi-line text file                | A meta file for arm-level copy number alteration data              | [Readme for Arm Level CNA](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna) | [Example of meta_armlevel_CNA.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna/meta_armlevel_CNA.txt) |
| Generic Assays: Arm-level CNA Data          | Optional                                           | data_armlevel_CNA.txt                       | Tab Separated Value (TSV)          | Arm-level copy number alteration data                               | [Readme for Arm Level CNA](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna) | [Example of data_armlevel_CNA.txt](https://github.com/FredHutch/tg-cbioportal-data/tree/main/01_file_formats/07_generic_assay_arm_level_cna/data_armlevel_CNA.txt) |
