...
Neighbors
  * [RcppArmadillo-0.10.1.2.0](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) 'Rcpp' Integration for the 'Armadillo' Templated Linear Algebra
Library
...
al.
  ...
  * [clusterProfiler-3.18.0](https://www.bioconductor.org/packages/release/bioc/html/clusterProfiler.html) statistical analysis and visualization of functional profiles for genes and gene clusters
...
Calls, Assignments and Other R Objects
  ...
  * [furrr-0.2.1](https://cran.r-project.org/web/packages/furrr/index.html) Apply Mapping Functions in Parallel using Futures
...
High-Dimensional Cytometry
  ...
  * [infer-0.5.3](https://cran.r-project.org/web/packages/infer/index.html) Tidy Statistical Inference
...
Components Analysis for Large Dense and Sparse Matrices
  * [isoband-0.2.3](https://cran.r-project.org/web/packages/isoband/index.html) Generate Isolines and Isobands from Regularly Spaced Elevation
Grids
...
Derivatives
  ...
  * [knitr-1.30](https://cran.r-project.org/web/packages/knitr/index.html) A General-Purpose Package for Dynamic Report Generation in R
...
Monte Carlo Studies
  ...
  * [labelled-2.7.0](https://cran.r-project.org/web/packages/labelled/index.html) Manipulating Labelled Data
...
Loops
  ...
  * [lava-1.6.8.1](https://cran.r-project.org/web/packages/lava/index.html) Latent Variable Models
  * [lavaan-0.6-7](https://cran.r-project.org/web/packages/lavaan/index.html) Latent Variable Analysis
  ...
  * [leiden-0.3.6](https://cran.r-project.org/web/packages/leiden/index.html) R Implementation of Leiden Clustering Algorithm
  * [lhs-1.1.1](https://cran.r-project.org/web/packages/lhs/index.html) Latin Hypercube Samples
  * [libcoin-1.0-6](https://cran.r-project.org/web/packages/libcoin/index.html) Linear Test Statistics for Permutation Inference
...
Equality/Inequality Constraints
  * [lubridate-1.7.9.2](https://cran.r-project.org/web/packages/lubridate/index.html) Make Dealing with Dates a Little Easier
...
Ensemble Feature Selection"
  ...
  * [magick-2.5.2](https://cran.r-project.org/web/packages/magick/index.html) Advanced Graphics and Image-Processing in R
  ...
  * [maptools-1.0-2](https://cran.r-project.org/web/packages/maptools/index.html) Tools for Handling Spatial Objects
  ...
  * [mathjaxr-1.0-1](https://cran.r-project.org/web/packages/mathjaxr/index.html) Using 'Mathjax' in Rd Files
  * [matrixStats-0.57.0](https://cran.r-project.org/web/packages/matrixStats/index.html) Functions that Apply to Rows and Columns of Matrices (and to
Vectors)
  ...
  * [maxLik-1.4-6](https://cran.r-project.org/web/packages/maxLik/index.html) Maximum Likelihood Estimation and Related Tools
...
Classification, and Density Estimation
  ...
  * methods built in
  * [methylKit-1.16.0](https://www.bioconductor.org/packages/release/bioc/html/methylKit.html) DNA methylation analysis from high-throughput bisulfite sequencing results
  ...
  * [mgcv-1.8-33](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
  * [mi-1.0](https://cran.r-project.org/web/packages/mi/index.html) Missing Data Imputation and Model Checking
  * [mice-3.12.0](https://cran.r-project.org/web/packages/mice/index.html) Multivariate Imputation by Chained Equations
...
Estimation of Mixture Proportions
  ...
  * [mlr-2.18.0](https://cran.r-project.org/web/packages/mlr/index.html) Machine Learning in R
...
Versions
  ...
  * [mpath-0.4-2.17](https://cran.r-project.org/web/packages/mpath/index.html) Regularized Linear Models
  ...
  * [multcomp-1.4-15](https://cran.r-project.org/web/packages/multcomp/index.html) Simultaneous Inference in General Parametric Models
...
Data and Resting State Data
  ...
  * [nlme-3.1-151](https://cran.r-project.org/web/packages/nlme/index.html) Linear and Nonlinear Mixed Effects Models
...
Dependencies
  ...
  * [parallelly-1.22.0](https://cran.r-project.org/web/packages/parallelly/index.html) Enhancing the 'parallel' Package
...
8601 Formats
  * [parsnip-0.1.4](https://cran.r-project.org/web/packages/parsnip/index.html) A Common API to Modeling and Analysis Functions
  ...
  * [partykit-1.2-11](https://cran.r-project.org/web/packages/partykit/index.html) A Toolkit for Recursive Partytioning
  ...
  * [pbkrtest-0.4-8.6](https://cran.r-project.org/web/packages/pbkrtest/index.html) Parametric Bootstrap, Kenward-Roger and Satterthwaite Based
...
in GLMs and in the Cox Model
  ...
  * [pillar-1.4.7](https://cran.r-project.org/web/packages/pillar/index.html) Coloured Formatting for Columns
...
Abundance and Multilocus Genetic Data
  ...
  * [preprocessCore-1.52.0](https://www.bioconductor.org/packages/release/bioc/html/preprocessCore.html) A collection of pre-processing functions
  ...
  * [processx-3.4.5](https://cran.r-project.org/web/packages/processx/index.html) Execute and Control System Processes
  ...
  * [ps-1.5.0](https://cran.r-project.org/web/packages/ps/index.html) List, Query, Manipulate System Processes
  ...
  * [psych-2.0.12](https://cran.r-project.org/web/packages/psych/index.html) Procedures for Psychological, Psychometric, and Personality
Research
...
Graphical Model Estimation
  ...
  * [quantreg-5.75](https://cran.r-project.org/web/packages/quantreg/index.html) Quantile Regression
...
and Logs
  ...
  * [rasterVis-0.49](https://cran.r-project.org/web/packages/rasterVis/index.html) Visualization Methods for Raster Data
...
'GitHub'
  ...
  * [reticulate-1.18](https://cran.r-project.org/web/packages/reticulate/index.html) Interface to 'Python'
  ...
  * [rgl-0.103.5](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  ...
  * [rlang-0.4.9](https://cran.r-project.org/web/packages/rlang/index.html) Functions for Base Types and Core R and 'Tidyverse' Features
  ...
  * [rmarkdown-2.6](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
  * [rmeta-3.0](https://cran.r-project.org/web/packages/rmeta/index.html) Meta-Analysis
  * [rms-6.1-0](https://cran.r-project.org/web/packages/rms/index.html) Regression Modeling Strategies
...
Ordinary Differential Equations
  ...
  * [rsample-0.0.8](https://cran.r-project.org/web/packages/rsample/index.html) General Resampling Infrastructure
...
Applications
  ...
  * [rstatix-0.6.0](https://cran.r-project.org/web/packages/rstatix/index.html) Pipe-Friendly Framework for Basic Statistical Tests
  ...
  * [rvest-0.3.6](https://cran.r-project.org/web/packages/rvest/index.html) Easily Harvest (Scrape) Web Pages
  ...
  * [segmented-1.3-1](https://cran.r-project.org/web/packages/segmented/index.html) Regression Models with Break-Points / Change-Points Estimation
  ...
  * [seqinr-4.2-4](https://cran.r-project.org/web/packages/seqinr/index.html) Biological Sequences Retrieval and Analysis
...
Files
  ...
  * [slider-0.1.5](https://cran.r-project.org/web/packages/slider/index.html) Sliding Window Functions
...
Estimation
  ...
  * [sp-1.4-4](https://cran.r-project.org/web/packages/sp/index.html) Classes and Methods for Spatial Data
  * [spData-0.3.8](https://cran.r-project.org/web/packages/spData/index.html) Datasets for Spatial Analysis
  * [spaMM-3.5.0](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, Particularly Spatial Models
  * [spam-2.6-0](https://cran.r-project.org/web/packages/spam/index.html) SPArse Matrix
  * [sparklyr-1.5.2](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [sparseMatrixStats-1.2.0](https://www.bioconductor.org/packages/release/bioc/html/sparseMatrixStats.html) Summary Statistics for Rows and Columns of Sparse Matrices
  ...
  * [spatstat.data-1.7-0](https://cran.r-project.org/web/packages/spatstat.data/index.html) Datasets for 'spatstat'
...
Software
  * stats built in
  * stats4 built in
  * [stopwords-2.1](https://cran.r-project.org/web/packages/stopwords/index.html) Multilingual Stopword Lists
...
Distance Functions
  ...
  * [survival-3.2-7](https://cran.r-project.org/web/packages/survival/index.html) Survival Analysis
  ...
  * [systemPipeR-1.24.2](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
  * [systemfonts-0.3.2](https://cran.r-project.org/web/packages/systemfonts/index.html) System Native Font Finding
...
Models
  * [testthat-3.0.0](https://cran.r-project.org/web/packages/testthat/index.html) Unit Testing for R
  * [threejs-0.3.3](https://cran.r-project.org/web/packages/threejs/index.html) Interactive 3D Scatter Plots, Networks and Globes
  * [tibble-3.0.4](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
...
Stack and List structures.
  ...
  * [tidyr-1.1.2](https://cran.r-project.org/web/packages/tidyr/index.html) Tidy Messy Data
  * [tidyselect-1.1.0](https://cran.r-project.org/web/packages/tidyselect/index.html) Select from a Set of Strings
  * [tidytext-0.2.6](https://cran.r-project.org/web/packages/tidytext/index.html) Text Mining using 'dplyr', 'ggplot2', and Other Tidy Tools
  ...
  * [tiff-0.1-6](https://cran.r-project.org/web/packages/tiff/index.html) Read and write TIFF images
  ...
  * [tinytex-0.28](https://cran.r-project.org/web/packages/tinytex/index.html) Helper Functions to Install and Maintain TeX Live, and Compile
LaTeX Documents
  ...
  * [tune-0.1.2](https://cran.r-project.org/web/packages/tune/index.html) Tidy Tuning Tools
  ...
  * [usethis-2.0.0](https://cran.r-project.org/web/packages/usethis/index.html) Automate Package and Project Setup
...
for Dimensionality Reduction
  ...
  * [vctrs-0.3.5](https://cran.r-project.org/web/packages/vctrs/index.html) Vector Helpers
...
Estimates
  ...
  * [waldo-0.2.3](https://cran.r-project.org/web/packages/waldo/index.html) Find Differences Between R Objects
...
Signal Processing
  ...
  * [withr-2.3.0](https://cran.r-project.org/web/packages/withr/index.html) Run Code 'With' Temporarily Modified Global State
  * [workflows-0.2.1](https://cran.r-project.org/web/packages/workflows/index.html) Modeling Workflows
  * [worrms-0.4.2](https://cran.r-project.org/web/packages/worrms/index.html) World Register of Marine Species (WoRMS) Client
  * xCell 1.1.0
  * [xfun-0.19](https://cran.r-project.org/web/packages/xfun/index.html) Miscellaneous Functions by 'Yihui Xie'
  * [xgboost-1.2.0.1](https://cran.r-project.org/web/packages/xgboost/index.html) Extreme Gradient Boosting
  ...
  * [xmlparsedata-1.0.4](https://cran.r-project.org/web/packages/xmlparsedata/index.html) Parse Data of 'R' Code as an 'XML' Tree
  ...
  * [yardstick-0.0.7](https://cran.r-project.org/web/packages/yardstick/index.html) Tidy Characterizations of Model Performance
