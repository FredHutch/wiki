...
NIFTI Format
  ...
  * [AnnotationHub-3.0.0](https://www.bioconductor.org/packages/release/bioc/html/AnnotationHub.html) Client to access AnnotationHub resources
  * ArchR 1.0.1
...
Statistics
  ...
  * [BiocManager-1.30.15](https://cran.r-project.org/web/packages/BiocManager/index.html) Access the Bioconductor Project Package Repository
  * [BiocParallel-1.26.0](https://www.bioconductor.org/packages/release/bioc/html/BiocParallel.html) Bioconductor facilities for parallel evaluation
  ...
  * [BiocStyle-2.20.0](https://www.bioconductor.org/packages/release/bioc/html/BiocStyle.html) Standard styles for vignettes and other Bioconductor documents
  ...
  * [Biostrings-2.60.1](https://www.bioconductor.org/packages/release/bioc/html/Biostrings.html) Efficient manipulation of biological strings
...
PostScript) and Display (X11 and Win32) Output
  ...
  * [ChIPpeakAnno-3.26.0](https://www.bioconductor.org/packages/release/bioc/html/ChIPpeakAnno.html) Batch annotation of the peaks identified from either ChIP-seq, ChIP-chip experiments or any experiments resulted in large number of chromosome ranges
  ...
  * [DHARMa-0.4.1](https://cran.r-project.org/web/packages/DHARMa/index.html) Residual Diagnostics for Hierarchical (Multi-Level / Mixed)
Regression Models
  ...
  * [DOSE-3.18.0](https://www.bioconductor.org/packages/release/bioc/html/DOSE.html) Disease Ontology Semantic and Enrichment analysis
  ...
  * [DT-0.18](https://cran.r-project.org/web/packages/DT/index.html) A Wrapper of the JavaScript Library 'DataTables'
...
Q-Learning, and Dynamic Weighted Survival Modeling (DWSurv)
  ...
  * [DelayedMatrixStats-1.14.0](https://www.bioconductor.org/packages/release/bioc/html/DelayedMatrixStats.html) Functions that Apply to Rows and Columns of 'DelayedMatrix' Objects
  * [Deriv-4.1.3](https://cran.r-project.org/web/packages/Deriv/index.html) Symbolic Differentiation
  * [DescTools-0.99.41](https://cran.r-project.org/web/packages/DescTools/index.html) Tools for Descriptive Statistics
  ...
  * [DiffBind-3.2.2](https://www.bioconductor.org/packages/release/bioc/html/DiffBind.html) Differential Binding Analysis of ChIP-Seq Peak Data
  ...
  * [ENMeval-2.0.0](https://cran.r-project.org/web/packages/ENMeval/index.html) Automated Tuning and Evaluations of Ecological Niche Models
  ...
  * [EpiModel-2.0.5](https://cran.r-project.org/web/packages/EpiModel/index.html) Mathematical Modeling of Infectious Disease Dynamics
...
Sensitivity, Identifiability and Monte Carlo Analysis
  ...
  * [GENESIS-2.22.1](https://www.bioconductor.org/packages/release/bioc/html/GENESIS.html) GENetic EStimation and Inference in Structured samples (GENESIS): Statistical methods for analyzing genetic data from samples with population structure and/or relatedness
  ...
  * [GOSemSim-2.18.0](https://www.bioconductor.org/packages/release/bioc/html/GOSemSim.html) GO-terms Semantic Similarity Measures
...
Model
  ...
  * GenomeGraphs 1.46.0
  * [GenomeInfoDb-1.28.0](https://www.bioconductor.org/packages/release/bioc/html/GenomeInfoDb.html) Utilities for manipulating chromosome names, including modifying them to follow a particular naming style
  ...
  * [GenomicFeatures-1.44.0](https://www.bioconductor.org/packages/release/bioc/html/GenomicFeatures.html) Conveniently import and query gene models
  ...
  * [Gmisc-2.0.2](https://cran.r-project.org/web/packages/Gmisc/index.html) Descriptive Statistics, Transition Plots, and More
  ...
  * [Gviz-1.36.1](https://www.bioconductor.org/packages/release/bioc/html/Gviz.html) Plotting data and annotation information along genomic coordinates
...
Optimization
  * [Matrix-1.3-3](https://cran.r-project.org/web/packages/Matrix/index.html) Sparse and Dense Matrix Classes and Methods
...
Operations
  * [MatrixGenerics-1.4.0](https://www.bioconductor.org/packages/release/bioc/html/MatrixGenerics.html) S4 Generic Summary Statistic Functions that Operate on Matrix-Like Objects
...
Models
  ...
  * [RPresto-1.3.6](https://cran.r-project.org/web/packages/RPresto/index.html) DBI Connector to Presto
...
(SNNS)
  * [RSQLite-2.2.7](https://cran.r-project.org/web/packages/RSQLite/index.html) 'SQLite' Interface for R
...
Neighbors
  * [RcppArmadillo-0.10.4.0.0](https://cran.r-project.org/web/packages/RcppArmadillo/index.html) 'Rcpp' Integration for the 'Armadillo' Templated Linear Algebra
Library
...
Implementations
  ...
  * [ReportingTools-2.32.0](https://www.bioconductor.org/packages/release/bioc/html/ReportingTools.html) Tools for making reports in various formats
  ...
  * [Rhdf5lib-1.14.1](https://www.bioconductor.org/packages/release/bioc/html/Rhdf5lib.html) hdf5 library as an R package
  ...
  * [Rlabkey-2.7.0](https://cran.r-project.org/web/packages/Rlabkey/index.html) Data Exchange Between R and 'LabKey' Server
  ...
  * [Rsubread-2.6.1](https://www.bioconductor.org/packages/release/bioc/html/Rsubread.html) Mapping, quantification and variant analysis of sequencing data
...
Matrices
  ...
  * [TMB-1.7.20](https://cran.r-project.org/web/packages/TMB/index.html) Template Model Builder: A General Random Effect Tool Inspired by
'ADMB'
...
in Environmental Sciences
  * [admisc-0.15](https://cran.r-project.org/web/packages/admisc/index.html) Adrian Dusa's Miscellaneous
  * [affxparser-1.64.0](https://www.bioconductor.org/packages/release/bioc/html/affxparser.html) Affymetrix File Parsing SDK
...
Animations
  * [annaffy-1.63.1](https://www.bioconductor.org/packages/release/bioc/html/annaffy.html) Annotation tools for Affymetrix biological metadata
...
'fmri', 'dwi'
  ...
  * [beachmat-2.8.0](https://www.bioconductor.org/packages/release/bioc/html/beachmat.html) Compiling Bioconductor to Handle Each Matrix Type
...
Files
  ...
  * [biomaRt-2.48.0](https://www.bioconductor.org/packages/release/bioc/html/biomaRt.html) Interface to BioMart databases (i.e. Ensembl)
...
Inference
  ...
  * [bookdown-0.22](https://cran.r-project.org/web/packages/bookdown/index.html) Authoring Books and Technical Documents with R Markdown
...
in Wang and Louis (2003)
  ...
  * [broom-0.7.6](https://cran.r-project.org/web/packages/broom/index.html) Convert Statistical Objects into Tidy Tibbles
  * [bslib-0.2.5.1](https://cran.r-project.org/web/packages/bslib/index.html) Custom 'Bootstrap' 'Sass' Themes for 'shiny' and 'rmarkdown'
  ...
  * [cachem-1.0.5](https://cran.r-project.org/web/packages/cachem/index.html) Cache R Objects with Automatic Pruning
...
(CGDS)
  ...
  * [cli-2.5.0](https://cran.r-project.org/web/packages/cli/index.html) Helpers for Developing Command Line Interfaces
...
al.
  ...
  * [clusterProfiler-4.0.0](https://www.bioconductor.org/packages/release/bioc/html/clusterProfiler.html) statistical analysis and visualization of functional profiles for genes and gene clusters
  ...
  * [colorspace-2.0-1](https://cran.r-project.org/web/packages/colorspace/index.html) A Toolbox for Manipulating and Assessing Colors and Palettes
...
Plots
  ...
  * [corrplot-0.88](https://cran.r-project.org/web/packages/corrplot/index.html) Visualization of a Correlation Matrix
...
Hazards Model
  ...
  * [curl-4.3.1](https://cran.r-project.org/web/packages/curl/index.html) A Modern and Flexible Web Client for R
...
('ODE', 'DAE', 'DDE')
  ...
  * [devtools-2.4.1](https://cran.r-project.org/web/packages/devtools/index.html) Tools to Make Developing R Packages Easier
...
Package
  * [doBy-4.6.10](https://cran.r-project.org/web/packages/doBy/index.html) Groupwise Statistics, LSmeans, Linear Contrasts, Utilities
  ...
  * [dplyr-1.0.6](https://cran.r-project.org/web/packages/dplyr/index.html) A Grammar of Data Manipulation
...
Theory Group (Formerly: E1071), TU Wien
  ...
  * [edgeR-3.34.0](https://www.bioconductor.org/packages/release/bioc/html/edgeR.html) Empirical Analysis of Digital Gene Expression Data in R
...
Regions
  ...
  * [enrichplot-1.12.0](https://www.bioconductor.org/packages/release/bioc/html/enrichplot.html) Visualization of Functional Enrichment Result
  * [ensembldb-2.16.0](https://www.bioconductor.org/packages/release/bioc/html/ensembldb.html) Utilities to create and use Ensembl-based annotation databases
...
Three-Dimensional, and Multivariate Transforms
  ...
  * [fields-12.3](https://cran.r-project.org/web/packages/fields/index.html) Tools for Spatial Data
...
'Systat', 'Weka', 'dBase', ...
  ...
  * [formatR-1.9](https://cran.r-project.org/web/packages/formatR/index.html) Format R Code Automatically
...
and Shape
  ...
  * [gargle-1.1.0](https://cran.r-project.org/web/packages/gargle/index.html) Utilities for Working with Google APIs
...
Enhancements
  ...
  * [ggplotify-0.0.7](https://cran.r-project.org/web/packages/ggplotify/index.html) Convert Plot to 'grob' or 'ggplot' Object
...
'ggplot2'
  ...
  * [ggtree-3.0.2](https://www.bioconductor.org/packages/release/bioc/html/ggtree.html) an R package for visualization of tree and annotation data
...
Distribution
  * [gllvm-1.3.0](https://cran.r-project.org/web/packages/gllvm/index.html) Generalized Linear Latent Variable Models
...
Likelihood
  ...
  * [googledrive-1.0.1](https://cran.r-project.org/web/packages/googledrive/index.html) An Interface to Google Drive
  * [googlesheets4-0.3.0](https://cran.r-project.org/web/packages/googlesheets4/index.html) Access Google Sheets using the Sheets API V4
...
Covariates
  ...
  * [h2o-3.32.1.2](https://cran.r-project.org/web/packages/h2o/index.html) R Interface for the 'H2O' Scalable Machine Learning Platform
...
when Linkage Phase is Ambiguous
  ...
  * [haven-2.4.1](https://cran.r-project.org/web/packages/haven/index.html) Import and Export 'SPSS', 'Stata' and 'SAS' Files
  ...
  * [httpuv-1.6.1](https://cran.r-project.org/web/packages/httpuv/index.html) HTTP and WebSocket Server Library
...
Network
  ...
  * [inline-0.3.18](https://cran.r-project.org/web/packages/inline/index.html) Functions to Inline C, C++, Fortran Function Calls from R
...
Monte Carlo Studies
  ...
  * [later-1.2.0](https://cran.r-project.org/web/packages/later/index.html) Utilities for Scheduling Functions to Execute Later with Event
Loops
  ...
  * [limma-3.48.0](https://cran.r-project.org/web/packages/limma/index.html) Linear Models for Microarray Data
  ...
  * [lme4-1.1-27](https://cran.r-project.org/web/packages/lme4/index.html) Linear Mixed-Effects Models using 'Eigen' and S4
...
Equality/Inequality Constraints
  ...
  * [magick-2.7.2](https://cran.r-project.org/web/packages/magick/index.html) Advanced Graphics and Image-Processing in R
...
Classification, and Density Estimation
  ...
  * [mgcv-1.8-35](https://cran.r-project.org/web/packages/mgcv/index.html) Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation
...
Algorithm Found in MINPACK, Plus Support for Bounds
  ...
  * [mixOmics-6.16.0](https://cran.r-project.org/web/packages/mixOmics/index.html) Omics Data Integration Project
...
Methods)
  ...
  * [openssl-1.4.4](https://cran.r-project.org/web/packages/openssl/index.html) Toolkit for Encryption, Signatures and Certificates Based on
OpenSSL
...
Dependencies
  ...
  * [parallelly-1.25.0](https://cran.r-project.org/web/packages/parallelly/index.html) Enhancing the 'parallel' Package
...
8601 Formats
  * [parsnip-0.1.6](https://cran.r-project.org/web/packages/parsnip/index.html) A Common API to Modeling and Analysis Functions
...
in GLMs and in the Cox Model
  ...
  * [phangorn-2.7.0](https://cran.r-project.org/web/packages/phangorn/index.html) Phylogenetic Reconstruction and Analysis
  ...
  * [pillar-1.6.1](https://cran.r-project.org/web/packages/pillar/index.html) Coloured Formatting for Columns
...
and Logs
  * [raster-3.4-10](https://cran.r-project.org/web/packages/raster/index.html) Geographic Data Analysis and Modeling
  * [rbenchmark-1.0.0](https://cran.r-project.org/web/packages/rbenchmark/index.html) Benchmarking routine for R
  * [rbibutils-2.1.1](https://cran.r-project.org/web/packages/rbibutils/index.html) Read 'Bibtex' Files and Convert Between Bibliography Formats
...
'Ensembl' and 'UCSC' Genome Browsers
  ...
  * [remotes-2.3.0](https://cran.r-project.org/web/packages/remotes/index.html) R Package Installation from Remote Repositories, Including
'GitHub'
  ...
  * [reprex-2.0.0](https://cran.r-project.org/web/packages/reprex/index.html) Prepare Reproducible Example Code via the Clipboard
  ...
  * [rgl-0.106.8](https://cran.r-project.org/web/packages/rgl/index.html) 3D Visualization Using OpenGL
  ...
  * [rmarkdown-2.8](https://cran.r-project.org/web/packages/rmarkdown/index.html) Dynamic Documents for R
...
Ordinary Differential Equations
  ...
  * [rsconnect-0.8.17](https://cran.r-project.org/web/packages/rsconnect/index.html) Deployment Interface for R Markdown Documents and Shiny
Applications
  ...
  * [rtracklayer-1.52.0](https://www.bioconductor.org/packages/release/bioc/html/rtracklayer.html) R interface to genome annotation files and the UCSC genome browser
  ...
  * [scatterpie-0.1.6](https://cran.r-project.org/web/packages/scatterpie/index.html) Scatter Pie Plot
...
Format and BGEN Format) into R
  ...
  * [servr-0.22](https://cran.r-project.org/web/packages/servr/index.html) A Simple HTTP Server to Serve Static Files or Dynamic Documents
...
the SUN
  ...
  * [spaMM-3.7.34](https://cran.r-project.org/web/packages/spaMM/index.html) Mixed-Effect Models, Particularly Spatial Models
  ...
  * [sparklyr-1.7.0](https://cran.r-project.org/web/packages/sparklyr/index.html) R Interface to Apache Spark
  * [sparseMatrixStats-1.4.0](https://www.bioconductor.org/packages/release/bioc/html/sparseMatrixStats.html) Summary Statistics for Rows and Columns of Sparse Matrices
  * [spatial-7.3-14](https://cran.r-project.org/web/packages/spatial/index.html) Functions for Kriging and Point Pattern Analysis
  * [spatstat-2.1-0](https://cran.r-project.org/web/packages/spatstat/index.html) Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
  * [spatstat.core-2.1-2](https://cran.r-project.org/web/packages/spatstat.core/index.html) Core Functionality of the 'spatstat' Family
  * [spatstat.data-2.1-0](https://cran.r-project.org/web/packages/spatstat.data/index.html) Datasets for 'spatstat' Family
  * [spatstat.geom-2.1-0](https://cran.r-project.org/web/packages/spatstat.geom/index.html) Geometrical Functionality of the 'spatstat' Family
...
Distance Functions
  * [stringi-1.6.2](https://cran.r-project.org/web/packages/stringi/index.html) Character String Processing Facilities
  ...
  * [survival-3.2-11](https://cran.r-project.org/web/packages/survival/index.html) Survival Analysis
  ...
  * [systemPipeR-1.26.2](https://www.bioconductor.org/packages/release/bioc/html/systemPipeR.html) systemPipeR: NGS workflow and report generation environment
...
Models
  ...
  * [tibble-3.1.2](https://cran.r-project.org/web/packages/tibble/index.html) Simple Data Frames
...
Stack and List Structures
  ...
  * [tidytree-0.3.4](https://cran.r-project.org/web/packages/tidytree/index.html) A Tidy Tool for Phylogenetic Tree Data Manipulation
  ...
  * [timereg-1.9.9](https://cran.r-project.org/web/packages/timereg/index.html) Flexible Regression Models for Survival Data
...
LaTeX Documents
  ...
  * [treeio-1.16.1](https://www.bioconductor.org/packages/release/bioc/html/treeio.html) Base Classes and Functions for Phylogenetic Tree Input and Output
  ...
  * [tune-0.1.5](https://cran.r-project.org/web/packages/tune/index.html) Tidy Tuning Tools
  ...
  * [unmarked-1.1.0](https://cran.r-project.org/web/packages/unmarked/index.html) Models for Data from Unmarked Animals
...
for Dimensionality Reduction
  ...
  * [vimp-2.2.1](https://cran.r-project.org/web/packages/vimp/index.html) Perform Inference on Algorithm-Agnostic Variable Importance
...
Signal Processing
  ...
  * [workflowsets-0.0.2](https://cran.r-project.org/web/packages/workflowsets/index.html) Create a Collection of 'tidymodels' Workflows
  * [worrms-0.4.2](https://cran.r-project.org/web/packages/worrms/index.html) World Register of Marine Species (WoRMS) Client
  * xCell 1.1.0
  * [xfun-0.23](https://cran.r-project.org/web/packages/xfun/index.html) Supporting Functions for Packages Maintained by 'Yihui Xie'
