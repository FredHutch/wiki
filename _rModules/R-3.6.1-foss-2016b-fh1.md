...
PostScript) and Display (X11 and Win32) Output
  ...
  * [ChIPpeakAnno-3.18.2](https://www.bioconductor.org/packages/release/bioc/html/ChIPpeakAnno.html) Batch annotation of the peaks identified from either ChIP-seq, ChIP-chip experiments or any experiments resulted in large number of chromosome ranges
...
Regression Models
  ...
  * [DTRreg-1.3](https://cran.r-project.org/web/packages/DTRreg/index.html) DTR Estimation and Inference via G-Estimation, Dynamic WOLS,
...
Model
  ...
  * [HSMMSingleCell-1.4.0](https://www.bioconductor.org/packages/release/bioc/html/HSMMSingleCell.html) Single-cell RNA-Seq for differentiating human skeletal muscle myoblasts (HSMM)
...
(www.zhaw.ch/idp)'
  * [IDSpatialStats-0.3.5](https://cran.r-project.org/web/packages/IDSpatialStats/index.html) Estimate Global Clustering in Infectious Disease
...
Optimization
  ...
  * [Matrix.utils-0.9.7](https://cran.r-project.org/web/packages/Matrix.utils/index.html) Data.frame-Like Operations on Sparse and Dense Matrix Objects
...
(SNNS)
  ...
  * [RcppAnnoy-0.0.12](https://cran.r-project.org/web/packages/RcppAnnoy/index.html) 'Rcpp' Bindings for 'Annoy', a Library for Approximate Nearest
Neighbors
...
Packages
  ...
  * [RhpcBLASctl-0.18-205](https://cran.r-project.org/web/packages/RhpcBLASctl/index.html) Control the Number of Threads on 'BLAS'
...
Algorithms
  ...
  * [SingleCellExperiment-1.6.0](https://www.bioconductor.org/packages/release/bioc/html/SingleCellExperiment.html) S4 Classes for Single Cell Data
...
Package
  * [doBy-4.6-2](https://cran.r-project.org/web/packages/doBy/index.html) Groupwise Statistics, LSmeans, Linear Contrasts, Utilities
...
Covariates
  * [grr-0.9.5](https://cran.r-project.org/web/packages/grr/index.html) Alternative Implementations of Base R Functions
...
Model Comparison
  * [pbmcapply-1.5.0](https://cran.r-project.org/web/packages/pbmcapply/index.html) Tracking the Progress of Mc*pply with Progress Bar
...
'Ensembl' and 'UCSC' Genome Browsers
  ...
  * [regioneR-1.16.2](https://www.bioconductor.org/packages/release/bioc/html/regioneR.html) Association analysis of genomic regions based on permutation tests
  ...
  * [regtools-1.0.1](https://cran.r-project.org/web/packages/regtools/index.html) Regression and Classification Tools
...
Estimation
  ...
  * [spdep-1.1-2](https://cran.r-project.org/web/packages/spdep/index.html) Spatial Dependence: Weighting Schemes, Statistics
  * [speedglm-0.3-2](https://cran.r-project.org/web/packages/speedglm/index.html) Fitting Linear and Generalized Linear Models to Large Data Sets
  * splines built in
...
Exponential-Family Random Graph Models
  ...
  * [tidyr-0.8.3](https://cran.r-project.org/web/packages/tidyr/index.html) Tidy Messy Data
...
'LaTeX' Documents
  ...
  * [uwot-0.1.3](https://cran.r-project.org/web/packages/uwot/index.html) The Uniform Manifold Approximation and Projection (UMAP) Method
