---
title: Translational Data Resources (CARDS)
...
- Governed, multimodal clinical datasets tailored for translational oncology priorities (OMOP, multimodal datasets such as annotated genomics or digital pathology data, etc.)

- Data exploration and visualization applications as well as computing, code management and AI capabilities (Atlas, cBioPortal, CARDS GitHub, Databricks all built on CARDS)

- Integrations and support for data analysis and workflows leveraging our resources moving to or from clinical (i.e., Epic, Cogito) or research data systems (e.g., REDCap, Cirro, HPC).

- Embedded data engineering, data science, informatics and data governance support as a central “hub” of translational data expertise
...
>Find out more (on campus or on VPN) at our internal site at [cards.fredhutch.org](cards.fredhutch.org).  