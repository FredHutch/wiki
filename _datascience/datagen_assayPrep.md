...
main_author: Sam Minot, Sitapriya Moorthi
primary_reviewers: 
...
### **1. Method of nucleic acid extraction to use**

When deciding which approach of nucleic acid isolation you should use you must consider atleast these three things:

  1.1. The **quantity and quality** of nucleic acid you need for the genomic assay you wish to use.
     
  1.2. **Source of samples** for extracting the nucleic acid for the assay.

  1.3. **DNA or RNA** specific considerations.

When weighing your options also thing about the inherent sample preparation steps involved in generating those data. 

#### 1.1 Deciding on **Quantity vs. Quality** of nucleic acid
...
#### 1.2 Deciding based on **sample source**
...
### **2. Assessing the yield or quantity of nucleic acid you have extracted**
...
### **2. Assessing the quality of nucleic acid you have extracted using Tapestation**
