---
title: PROOF Release Notes
primary_reviewers: seankross
---

[PROOF](/datascience/proof/) is a collection of projects designed to help
researchers run WDL workflows on the Fred Hutch cluster. On this page we 
document release notes for updates to PROOF software.

## PROOF Workbench

### January 2026 - v0.0.0.9000

**What's New**

- **Alpha Release**: This version of PROOF Workbench is intended for testing
