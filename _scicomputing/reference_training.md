...
](https://sciwiki.fredhutch.org/scicomputing/reference_training/).
...
](https://sciwiki.fredhutch.org/scicomputing/reference_training/). Note: If you do not have a laptop available to you we still want you to come!! You can email code privately ahead of each event to Amy Paguirigan (apaguiri at fredhutch.org).
...
- **Retired Community Groups:** These are community groups that initially served a purpose but waned over time with community involvement and thus have been retired
  - Software design group: ~~Discusses issues related to software engineering and interface design and invites speakers on specific topics and participants to share their coding projects. This group is not focused on a specific programming language, but rather on issues common across software projects.~~
