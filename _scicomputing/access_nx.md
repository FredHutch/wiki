...
Installation of the NoMachine client starts with download of the installer from [NoMachine](https://www.nomachine.com/product&p=NoMachine%20Enterprise%20Client).  Choose the version for your OS and follow the instructions provided by NoMachine.
