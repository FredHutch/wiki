...
---
<font size="2"><a href="{{site.github.repository_url}}/blob/master/{{page.relative_path}}"><i class="fas fa-pen-square"></i><span> Edit this Page using GitHub</span></a>  <a href="{{site.github.repository_url}}/issues"><i class="far fa-comment-dots"></i><span> Comment by Filing an Issue</span></a></font>
---
